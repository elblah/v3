...
PROTOCOL = (
    ...
    "Analyze and comment freely while guiding: your words become the worker's next instruction.\n"
    "But you carry the decision: when the work is DONE, or derailed/spinning with no task,\n"
    "halt the session by printing [STOP] ALONE ON ITS OWN LINE - nothing else on that line.\n"
    ...
    "Continuing? Give ONE concrete next action.\n"
